...
if test -f ${DESTDIR}/home/jiamin/usr/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/home/jiamin/usr/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/home/jiamin/usr/bin/apu-1-config
else
...
test -n "/home/jiamin/usr/bin/apu-1-config" && APU_INCLUDEDIR="`${APU_CONFIG} --includedir`"

installbuilddir="/home/jiamin/usr/build"
